...
resource "coder_agent" "main" {
  ...
  startup_script = <<-EOT
    ...
    # Install TPM if not previously installed
    if [ ! -d "/home/caiodelgadonew/.tmux/plugins/tpm" ]; then
      git clone https://github.com/tmux-plugins/tpm /home/caiodelgadonew/.tmux/plugins/tpm
    else
